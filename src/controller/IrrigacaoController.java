...
public class IrrigacaoController implements Serializable 
{
	...
	public void setDados(String dados)
	{
		try 
		{
			BufferedReader arquivo = new BufferedReader(new FileReader("C:\\Users\\franc\\Desktop\\Projeto Estrutura de Dados\\workspace\\ProjetoIrrigacao\\Historico_de_Log.txt"));
